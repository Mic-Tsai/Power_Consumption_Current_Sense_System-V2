...
float ADC0_A0_A1_Resistor = 0;   float ADC0_A0_A1_Resistor_Change = 30;
float ADC0_A2_A3_Resistor = 0;   float ADC0_A2_A3_Resistor_Change = 20;
...
//                         tft.fillRect(18+2, 34+1 +27, 85, 20, ST77XX_BLACK);
    ...
    Serial.print("P-load: "); Serial.print(PL_ADC0_CH2, 3); Serial.print("mW | ");
